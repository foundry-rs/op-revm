...
use revm::{
    ...
    interpreter::{
        interpreter::EthInterpreter, interpreter_action::FrameInit, Gas, GasTracker,
        InitialAndFloorGas,
    },
...
mod tests {
    ...
    fn call_last_frame_return(
        ...
        handler
            .last_frame_result(&mut evm, &mut exec_result, &mut parent_gas)
            .unwrap();
    ...
    fn test_remove_l1_cost_lack_of_funds() {
        ...
        // l1block cost is 1048 fee.
        assert_eq!(
            handler.validate_against_state_and_deduct_caller(&mut evm, &mut InitialAndFloorGas::default()),
